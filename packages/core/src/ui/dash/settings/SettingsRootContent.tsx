  ...
  return (
    <div class="settings-root">
      ...
      >
        ...
        />
        <SettingsDirectoryLink
          href={toPublicPath("/settings/language", sitePathPrefix)}
          icon={ICONS.languages}
          tone="subtle"
          name={i18n._(
            msg({
              message: "Language",
              comment: "@context: Settings item — language settings",
            }),
          )}
          description={i18n._(
            msg({
              message: "Content language, dashboard language, multilingual",
              comment: "@context: Settings item description for language",
            }),
          )}
        />
        <SettingsDirectoryLink
      ...
      >
        ...
        />
        <SettingsDirectoryLink
          href={toPublicPath("/settings/config", sitePathPrefix)}
          icon={ICONS.sliders}
          tone="subtle"
          name={i18n._(
            msg({
              message: "Config Editor",
              comment: "@context: Settings item — Config Editor",
            }),
          )}
          description={i18n._(
            msg({
              message:
                "Search runtime settings and open advanced configuration",
              comment: "@context: Settings item description for Config Editor",
            }),
          )}
        />
      </SettingsDirectorySection>
