 ...
 * nested microformat. Every card ships `PostStatusBadges` in the DOM and hides
 * the inapplicable ones with CSS — which a parser does not run — so a card with
 * nothing else in it publishes a title of "PinnedPinnedPrivateDraft" followed
 * by its own date.
 *
