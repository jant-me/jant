...
| Element                  | Count | Notes                                                                                                                                                                                                                                                                                                                         |
| ------------------------ | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`                     | 1     | **Always the post's permalink.** It moves when a slug is renamed or the site changes domain; `jant:id` does not. It stays the permalink anyway, because changing it would make every subscriber's reader show the feed again.                                                                                                 |
